          ...
          <Grid item xs={12} sm={4}>
            <div className={classes.white}>
              <ul style={{ listStyle: "none", margin: 0 }}>
                ...
                <li>
                  A web application that is built using React, Node.js and
                  Material UI that request data from a Star Wars API server and
                  displays each character's information on the page.
                </li>
              </ul>
            </div>
          </Grid>
